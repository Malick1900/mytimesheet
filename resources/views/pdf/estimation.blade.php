...
<head>
    ...
    <title>Estimation - {{ $employee->last_name }} {{ $employee->first_name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        th:last-child, th:nth-child(2), th:nth-child(3) {
            text-align: right;
        }
        td {
            padding: 12px 15px;
        ...
        td:last-child, td:nth-child(2), td:nth-child(3) {
            text-align: right;
